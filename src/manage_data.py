...
def delete_old_records():
    try:
        data_base.cursor.execute(delete_query)
    ...
    try:
        with open("unosof_data_cst.csv", mode='r', encoding='utf-8') as file:
            ...
            for row in reader:
                ...
                try:
                    data_base.cursor.execute(data_base.insert_query, cleaned_row)
        ...
        print(message)
        data_base.log_to_db("ERROR", message, endpoint='fallido', status_code=404)
